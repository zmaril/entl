...
pub fn node_binding(api: &ApiDoc, enums: &[(String, Vec<String>)]) -> String {
...
pub fn python_binding(api: &ApiDoc, enums: &[(String, Vec<String>)]) -> String {
    let mut t: rust::Tokens = quote! {
        use std::sync::Arc;
        use std::time::Duration;
...
pub fn ruby_binding(api: &ApiDoc, enums: &[(String, Vec<String>)]) -> String {
