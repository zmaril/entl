...
// 28-table accounting: concrete entity tables + relation tables
...
check(concrete.length === 22, `22 concrete entities (got ${concrete.length})`);
check(relTables.length === 6, `6 relation tables (got ${relTables.length})`);
check(new Set([...entityTables, ...relTables]).size === 28, "28 distinct tables");
